...
function Nastedif() {
    ...
    <div className="input"> 
        <input type="number" value={yourScore} placeholder="Enter your score" required onChange={(e) => setYourScore(e.target.value)}/>
    </div>
    <div className="input">
        <input type="number" value={friendScore} placeholder="Enter your friend score" required onChange={(e) => setFriendScore(e.target.value)}/>
    </div>
    <div className="btn">
