...
let data = ["", "", "", "", "", "", "", "", ""];
 ...
 const TicTacToe = () => {
  ...
  const won = (winner) => {
    setLock(true);
    if(winner === "x")
      titleRef.current.innerHTML = `Congratulations! Player 1 wins! <img src='${cross_icon}'>`;
    else
      titleRef.current.innerHTML = `Congratulations! Player 2 wins! <img src='${circle_icon}'>`;
  }
